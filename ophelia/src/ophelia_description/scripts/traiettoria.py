...
class Cinematica:
    ...
    def calcoloIK_joint2(self,x,y,z):
        ...
        a1 = math.asin((l1)/(l2))
        a2 = math.acos((math.pow(f,2)-math.pow(t,2)+math.pow(l2,2))/(2*f*l2))
    ...
    def calcoloIK_joint3(self,x,y,z):
        ...
        b=math.acos((math.pow(t,2)+math.pow(f,2)-math.pow(x,2)-math.pow(y,2)-math.pow(a,2)-math.pow(z,2)+(2*a*math.sqrt(math.pow(x,2)+math.pow(y,2))))/(2*f*t))
