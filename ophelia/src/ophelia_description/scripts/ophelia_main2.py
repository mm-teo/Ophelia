...
class Movement:
  ...
  def moving(self):
    ...
    Movement.move.name = ['anca_dx_1_joint', 'femore_dx_1_joint', 'tibia_dx_1_joint', 'anca_dx_2_joint', 'femore_dx_2_joint', 'tibia_dx_2_joint', 'anca_dx_3_joint', 'femore_dx_3_joint', 'tibia_dx_3_joint', 'anca_sx_1_joint', 'femore_sx_1_joint', 'tibia_sx_1_joint', 'anca_sx_2_joint', 'femore_sx_2_joint', 'tibia_sx_2_joint', 'anca_sx_3_joint', 'femore_sx_3_joint','tibia_sx_3_joint']
  ...
  def ruotaDestra(self):
    ...
    if Movement.firstStep == 1:
      while Movement.z3<-80:
        #d=right a=coxa, f=femur, t=tibia
        Movement.dx_a_1 = Movement.braccio1.calcoloIK_joint1(Movement.x, Movement.y, Movement.z3)
        Movement.dx_f_1 = Movement.braccio1.calcoloIK_joint2(Movement.x, Movement.y, Movement.z3)
        Movement.dx_t_1 = Movement.braccio1.calcoloIK_joint3(Movement.x, Movement.y, Movement.z3)
  ...
  def ruotaDestraUscita(self):
    ...
    while Movement.z2>-130:
      #d=right a=coxa, f=femur, t=tibia
      Movement.dx_a_1 = Movement.braccio1.calcoloIK_joint1(Movement.x, Movement.y, Movement.z2)
      Movement.dx_f_1 = Movement.braccio1.calcoloIK_joint2(Movement.x, Movement.y, Movement.z2)
      Movement.dx_t_1 = Movement.braccio1.calcoloIK_joint3(Movement.x, Movement.y, Movement.z2)
